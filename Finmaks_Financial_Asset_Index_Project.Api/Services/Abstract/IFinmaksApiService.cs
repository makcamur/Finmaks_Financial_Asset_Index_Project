...
namespace Finmaks_Financial_Asset_Index_Project.Api.Services.Abstract
{
    public interface IFinmaksApiService
    {
        ...
        public AssetIndexExchangeFinalTableDTO CalculateFinalTable(AssetResultDTO asset, IndexResultDTO ındex,ExchangeResultDTO exchange,DateTime startDateInterval, DateTime lastDateInterval);
